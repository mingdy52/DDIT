<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
          ...
          <div class="row justify-content-between pb-2 pt-8">
            <div class="col-12 col-lg-auto mb-5 mb-lg-0"><a class="d-flex align-items-center fw-semi-bold fs-3" href="#"> <img class="me-3" src="${cPath}/resources/ex/assets/img/gallery/footer-logo.png" alt="..." /></a>
            ...
            <div class="col-auto mb-3">
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                ...
                <li class="mb-3"><a class="text-100 fw-light text-decoration-none" href="#!">공지사항</a></li>
                <li class="mb-3"><a class="text-100 fw-light text-decoration-none" href="#!">블로그 이용안내</a></li>
                <li class="mb-3"><a class="text-100 fw-light text-decoration-none" href="#!">협업툴 이용안내</a></li>
              </ul>
            </div>
            <div class="col-auto mb-3">
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="mb-3"><a class="text-100 fw-light text-decoration-none" href="#!">EXPERT 이용안내</a></li>
                <li class="mb-3"><a class="text-100 fw-light text-decoration-none" href="${cPath }/expert/form">전문가 신청</a></li>
                <li class="mb-3"><a class="text-100 fw-light text-decoration-none" href="#!">문의</a></li>
                <li class="mb-3"><a class="text-100 fw-light text-decoration-none" href="#!">서비스 이용안내</a></li>
              </ul>
            </div>
