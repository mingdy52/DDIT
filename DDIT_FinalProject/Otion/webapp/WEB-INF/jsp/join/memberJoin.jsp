...
<meta charset="utf-8" />
<title>Form Elements | Medroc - Admin & Dashboard Template</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body data-topbar="dark">
					...
					<div class="navbar-brand-box">
						<a href="index.html" class="logo logo-dark"> <span
							class="logo-sm"> <img src="assets/images/logo-sm.png"
								...
								src="assets/images/logo-dark.png" alt="" height="20">
						</span>
						</a> <a href="index.html" class="logo logo-light"> <span
							class="logo-sm"> <img
								src="assets/images/logo-sm-light.png" alt="" height="22">
						</span> <span class="logo-lg"> <img
								src="assets/images/logo-light.png" alt="" height="20">
						</span>
						</a>
					</div>
					<button type="button"
								...
								<a href="" class="text-reset notification-item">
									<div class="d-flex align-items-center">
										...
										<div class="flex-grow-1 text-truncate">
											<h6 class="mt-0 mb-1">
												Order placed <span class="mb-1 text-muted fw-normal">If
													several languages the grammar</span>
											</h6>
									...
									<div class="d-flex align-items-center">
										...
										<div class="flex-grow-1 text-truncate">
											<h6 class="mt-0 mb-1">
												Your item is shipped <span class="mb-1 text-muted fw-normal">If
													several languages coalesce the grammar.</span>
											</h6>
											<p class="mb-0 font-size-12">
												<i class="mdi mdi-clock-outline"></i> 3 min ago
											</p>
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
							...
							<div data-simplebar style="max-height: 230px;">
								...
								<a href="" class="text-reset notification-item">
									<div class="d-flex align-items-center">
										...
										<div class="flex-grow-1 text-truncate">
											<h6 class="mb-1">
												Settings <span class="badge bg-success float-end mt-1">11</span>
											</h6>
							...
							<div class="pt-2 border-top">
								<div class="d-grid">
									<a class="btn btn-sm btn-link font-size-14 text-center"
										href="javascript:void(0)"> <i
										class="ri-shut-down-line align-middle me-1"></i> Logout
									</a>
								</div>
							</div>
						</div>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									...
									<p class="card-title-desc">OTION에 오신 것을 환영합니다!</p>
									<div class="row mb-3">
										<label for="example-text-input"
											class="col-sm-2 col-form-label">ID</label>
										<div class="col-sm-10">
											<input class="form-control" type="text"
												placeholder="ID는 8글자까지 입력이 가능합니다." id="example-text-input">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-10">
											<input class="form-control" type="search"
												placeholder="PASSWORD는 영문자, 숫자를 조합하여 4-8글자로 설정이 가능합니다."
									...
									<div class="row mb-3">
										...
										<div class="col-sm-10">
											<input class="form-control" type="email"
												placeholder="이름을 입력하시오." id="example-email-input">
										</div>
									</div>
									<div class="row mb-3">
										<label for="example-url-input" class="col-sm-2 col-form-label">NICKNAME</label>
										<div class="col-sm-10">
											<input class="form-control" type="url"
												placeholder="닉네임은 최대 8글자까지 가능합니다." id="example-url-input">
											<input type="button" value="중복확인">
										</div>
									</div>
									<div class="row mb-3">
										<label for="example-tel-input" class="col-sm-2 col-form-label">E-MAIL</label>
										<div class="col-sm-10">
											<input class="form-control" type="email" placeholder="이메일 내놩"
									...
									<div class="row mb-3">
										...
										<div class="col-sm-10">
											<input class="form-control" type="tel"
												placeholder="EX)01011112222, '-' 는 제외하고 번호만 입력하셈." id="example-tel-input">
										</div>
									</div>
									<div>
										<a href="가입이 완료되었습니다 alert가 뜬 후 완료된 상태로 메인이 떠야함. 아니면 상황에 따라 실패 메세지를 남기던가. 링크 걸어야하는데 모르겠어.ㅠㅠ">
	...
	<script
		src="assets/libs/bs-custom-file-input/bs-custom-file-input.min.js"></script>
