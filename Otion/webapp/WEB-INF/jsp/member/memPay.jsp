...
<div class="card-body">
    ...
    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" data-bs-toggle="tab" href="#exPayList" role="tab" aria-selected="true" id="expertPay">
                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                <span class="d-none d-sm-block">expert결제내역</span> 
            </a>
        </li>
        <li class="nav-item" onClick="coopPayList()">
            <a class="nav-link" data-bs-toggle="tab" href="#coPayList" role="tab" aria-selected="false" id="coopPay">
                <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                <span class="d-none d-sm-block">협업툴결제내역</span> 
            </a>
        </li>
    </ul>
    ...
    <div class="tab-content p-3 text-muted">
        <div class="tab-pane active" id="exPayList" role="tabpanel">
        ...
        <div class="tab-pane" id="coPayList" role="tabpanel">
...
let expertPath="${cPath}/myexpert";
let coopPath="${cPath}/project";
</script>
<script src="${cPath }/resources/js/member/memPay.js"></script>