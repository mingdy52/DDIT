...
<html lang="en">
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="${cPath }/resources/assets/images/favicon.ico">

        <!-- jquery.vectormap css -->
        <link href="${cPath }/resources/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        ...
        <script src="https://unpkg.com/sweetalert/dist/sweetalert.min"></script>
	<style>
		.teamName{
		font-size: 32.5px; 
		color: white
...
<!--                 projheader -->
            ...
            <div class="main-content">
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">                                                     
                                <div class="page-title-box d-flex align-items-center justify-content-between" style="padding-bottom: 0; padding-left: 14px;">
        ...
        <!-- apexcharts -->
        <script src="${cPath}/resources/assets/libs/apexcharts/apexcharts.min.js"></script>

        <!-- jquery.vectormap map -->
        <script src="${cPath}/resources/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="${cPath}/resources/assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-us-merc-en.js"></script>
