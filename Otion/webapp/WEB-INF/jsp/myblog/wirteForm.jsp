...
<button class="btn btn-primary waves-effect waves-light" id="save-button">작성</button>
	...
	<form:form id="postForm" modelAttribute="mypost" method="post" enctype="multipart/form-data">
		...
		<form:input path="postTag"/>
		<form:input path="blogerId" value="${mypost.blogerId}"/>
		<form:input path="postPublicYn"/>
		<form:input path="postCateNum"/>
		<form:input type="file" path="postFiles" multiple="true"/>
		<form:input path="thumnail"/>
<!-- 		<input type="submit" value="전송"> -->
   ...
   <script>
    ...
    function DelTag(event){
    	...
    	$("span[data-value="+targetIdx+"]").remove();
