 ...
 */
	...
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp /*req, resp는 응답이 오면 사라짐*/) throws ServletException, IOException {
		// 세션을 가져오는데 없으면 새로 생성한다. 지우지 않으면 세션이 끝날 때까지 존재함.
